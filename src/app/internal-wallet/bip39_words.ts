// words.js
// This file contains the BIP39 English wordlist.
...
export const BIP39_WORDS = [
  ...
  "anxiety", "any", "apart", "apology", "appear", "apple", "apply", "april",
  ...
  "bachelor", "bacon", "badge", "badly", "bag", "bake", "balance", "balcony",
  "ball", "bamboo", "banana", "banner", "barber", "barely", "bargain", "barrel",
  ...
  "boil", "bold", "bomb", "bone", "bonus", "book", "boost", "border",
  ...
  "bulb", "bulk", "bullet", "bundle", "burden", "burger", "burst", "bus",
  "business", "busy", "butter", "buyer", "buzz", "cabbage", "cabin", "cable",
  "cactus", "caffeine", "cage", "cake", "call", "calm", "camera", "camp",
  "canal", "cancel", "candy", "cannon", "canoe", "canvas", "canyon", "capable",
  "capital", "captain", "car", "carbon", "card", "cargo", "carpet", "carry",
  "cart", "case", "cash", "casino", "castle", "casual", "cat", "catalog",
  "catch", "category", "cattle", "caught", "cause", "caution", "cave", "cease",
  "celery", "cement", "census", "century", "certain", "chain", "chair", "chalk",
  "champion", "change", "channel", "chapter", "charge", "chase", "chat", "cheap",
  "check", "cheese", "chef", "cherry", "chest", "chicken", "chief", "child",
  "chimney", "choice", "choose", "chuckle", "cigar", "cinnamon", "circle", "citizen",
  "city", "civil", "claim", "clap", "clarify", "clash", "class", "clean",
  "clerk", "clever", "click", "client", "cliff", "climb", "clinic", "clip",
  "clock", "clog", "close", "cloth", "cloud", "clown", "club", "clump",
  "cluster", "coach", "coal", "coast", "code", "coffee", "coil", "coin",
  "collect", "color", "column", "combine", "come", "comfort", "comic", "common",
  "company", "compete", "console", "contain", "control", "copy", "coral", "core",
  ...
  "danger", "daring", "dash", "data", "date", "daughter", "dawn", "day",
  "deal", "debate", "debris", "decade", "december", "decimal", "decline", "decorate",
  ...
  "diamond", "diary", "diet", "differ", "digital", "dignity", "dilemma", "dinner",
  ...
  "door", "dose", "double", "dough", "down", "dozen", "draft", "dragon",
  "drain", "drama", "drastic", "draw", "dream", "dress", "drift", "drill",
  "drink", "drip", "drive", "drop", "drum", "dry", "duck", "dumb",
  "dune", "during", "dust", "dutch", "duty", "dwarf", "dynamic", "eager",
  "eagle", "early", "earn", "earth", "easily", "east", "easy", "echo",
  "ecology", "economy", "edge", "edit", "educate", "effort", "egg", "eight",
  "either", "elbow", "elder", "electric", "elegant", "element", "elephant", "elevator",
  "elite", "else", "embark", "embrace", "emerge", "emotion", "employ", "empty",
  ...
  "genuine", "geography", "gesture", "get", "ghost", "giant", "gift", "giggle",
  "ginger", "giraffe", "girl", "give", "glad", "glance", "glass", "glide",
  "glimpse", "globe", "gloom", "glory", "glove", "glow", "glue", "goat",
  "goddess", "gold", "good", "goose", "gorgeous", "gospel", "gossip", "govern",
  ...
  "hard", "harvest", "hat", "have", "hawk", "hazard", "head", "health",
  ...
  "hour", "hover", "how", "html", "huge", "human", "humble", "humor",
  "hundred", "hungry", "hunt", "hurry", "hurt", "husband", "hybrid", "ice",
  "icon", "idea", "identify", "idle", "ignore", "ill", "illegal", "illness",
  "image", "imagine", "immense", "immune", "impact", "impose", "improve", "impulse",
  "inch", "include", "income", "increase", "index", "indicate", "indoor", "industry",
  "infant", "inform", "initial", "inject", "injury", "inmate", "inner", "innocent",
  "input", "inquiry", "insane", "insect", "inside", "inspire", "install", "intact",
  "interest", "into", "invest", "invite", "iron", "island", "isolate", "issue",
  "item", "ivory", "jacket", "jaguar", "jar", "jazz", "jealous", "jeans",
  "jelly", "jewel", "job", "join", "joke", "journey", "joy", "judge",
  "juice", "july", "jumbo", "jump", "jungle", "junior", "junk", "just",
  ...
  "lady", "lake", "lamp", "language", "laptop", "large", "late", "later",
  "latin", "laugh", "laundry", "lava", "lavender", "law", "lawn", "leader",
  "leaf", "learn", "lease", "least", "leave", "lecture", "left", "leg",
  "legal", "legend", "leisure", "lemon", "lend", "length", "lentil", "leopard",
  ...
  "maple", "marble", "march", "margin", "marine", "market", "marvel", "mass",
  ...
  "million", "mimic", "mind", "minimum", "minor", "mint", "minute", "miracle",
  "mirror", "misery", "miss", "mistake", "mix", "mixed", "mixture", "mobile",
  "mock", "model", "modify", "mom", "moment", "monitor", "monkey", "monster",
  "month", "moon", "moral", "more", "morning", "mosquito", "mother", "motion",
  "motor", "mountain", "mouse", "move", "movie", "much", "muffin", "mule",
  "multiply", "muscle", "museum", "mushroom", "music", "must", "mutual", "my",
  ...
  "next", "nice", "night", "nimble", "nine", "nitrogen", "no", "noble",
  "noise", "nomad", "north", "nose", "notable", "note", "nothing", "notice",
  "novel", "now", "nuclear", "number", "nurse", "nut", "oak", "obey",
  "object", "oblige", "obscure", "observe", "obtain", "obvious", "occasion", "occupy",
  ...
  "over", "own", "owner", "oxygen", "oyster", "ozone", "pace", "pacific",
  "package", "paddle", "page", "pair", "palm", "panda", "panel", "panic",
  "panther", "paper", "parade", "parent", "park", "parrot", "party", "pass",
  "patch", "path", "patient", "patrol", "pause", "pave", "payment", "peace",
  "peanut", "pear", "peasant", "pelican", "pen", "penalty", "pencil", "people",
  "pepper", "perfect", "permit", "personal", "pet", "phantom", "phase", "photo",
  "phrase", "physical", "piano", "picnic", "picture", "piece", "pig", "pigeon",
  "pill", "pilot", "pink", "pioneer", "pipe", "pistol", "pitch", "pizza",
  "place", "plain", "planet", "plastic", "plate", "play", "please", "pledge",
  "pluck", "plug", "plunge", "poem", "poet", "point", "polar", "pole",
  "police", "pond", "pony", "pool", "popular", "portion", "position", "possible",
  "post", "potato", "pottery", "pouch", "pound", "pour", "powder", "power",
  "practice", "praise", "predict", "prefer", "prepare", "present", "prevent", "price",
  ...
  "purse", "push", "put", "puzzle", "pyramid", "quality", "quantify", "quarter",
  ...
  "resource", "response", "result", "retire", "retreat", "return", "reveal", "review",
  "reward", "rhythm", "ribbon", "rice", "ridge", "rifle", "right", "rigid",
  "ring", "riot", "ripple", "risk", "ritual", "rival", "river", "road",
  "roast", "robot", "robust", "rocket", "romance", "roof", "rookie", "room",
  "rose", "rotate", "rough", "round", "route", "royal", "rubber", "rug",
  "rugby", "ruin", "rule", "run", "runway", "rural", "sad", "saddle",
  ...
  "sentence", "series", "service", "session", "set", "settle", "setup", "seven",
  "shadow", "shaft", "shallow", "shame", "shape", "share", "shark", "sharp",
  "sheep", "sheet", "shelf", "shell", "sheriff", "shield", "shift", "shine",
  "ship", "shiver", "shock", "shoe", "shoot", "shop", "short", "shoulder",
  "shove", "shrimp", "shrink", " Tijdens", "shuffle", "shy", "sibling", "sick",
  ...
  "slab", "slam", "sleep", "slight", "slim", "slogan", "slot", "slow",
  "slush", "small", "smart", "smile", "smoke", "smooth", "snack", "snake",
  "snap", "sniff", "snow", "soap", "soccer", "social", "sock", "soft",
  "soggy", "soil", "solar", "soldier", "solid", "solution", "solve", "some",
  "someone", "song", "soon", "sorry", "sort", "soul", "sound", "soup",
  "source", "south", "space", "spare", "spark", "speak", "special", "speed",
  "spell", "spend", "sphere", "spice", "spider", "spike", "spin", "spirit",
  "split", "sport", "spot", "spring", "spy", "square", "squeeze", "squirrel",
  ...
  "style", "subject", "submit", "subway", "success", "sudden", "suffer", "sugar",
  ...
  "valve", "van", "vanish", "vapor", "various", "vast", "vessel", "veteran",
  "Vial", "vibration", "victory", "view", "village", "vintage", "violin", "virtual",
  "virus", "visa", "visit", "visual", "vital", "vivid", "vocal", "voice",
  "void", "volcano", "volume", "vote", "voyage", "wage", "wagon", "wait",
  "walk", "wall", "walnut", "want", "war", "wardrobe", "wear", "weasel",
  "weather", "web", "wedding", "weekend", "weird", "welcome", "west", "wet",
  "whale", "what", "wheat", "wheel", "when", "where", "while", "whisper",
  "wide", "widget", "wild", "will", "win", "window", "wine", "wing",
  ...
  "yard", "year", "yellow", "you", "young", "youth", "zero", "zone",
  "zoo"
];
